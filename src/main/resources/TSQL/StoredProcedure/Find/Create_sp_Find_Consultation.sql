...
BEGIN
    ...
    DECLARE
        @tbl_Consultation_EmployeeBridge AS TableType_Consultation_Employee_Bridge
    ...
    FROM @tbl_Consultation
             INNER JOIN @tbl_Consultation_EmployeeBridge ON [@tbl_Consultation].fld_ConsultationID =
                                                            [@tbl_Consultation_EmployeeBridge].fld_ConsultationID
             INNER JOIN @tbl_Employee
                        ON [@tbl_Consultation_EmployeeBridge].fld_EmployeeID = [@tbl_Employee].fld_EmployeeID
