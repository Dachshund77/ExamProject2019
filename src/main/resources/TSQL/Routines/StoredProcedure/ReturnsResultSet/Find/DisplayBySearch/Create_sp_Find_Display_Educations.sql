CREATE OR ALTER PROCEDURE sp_Find_Display_Educations(@CompanyID INT, @CvrNr NVARCHAR(80),
...
BEGIN
    ...
    WHERE [@tbl_EducationWish].fld_InterviewID IS NOT NULL
       OR [@tbl_FinishedEducation].fld_InterviewID IS NOT NULL
END;