CREATE OR ALTER PROCEDURE sp_Find_Display_Interviews(@CompanyID INT, @CvrNr NVARCHAR(80),
                                                    @CompanyName NVARCHAR(50), @ConsultationID INT, @ConsultationName NVARCHAR(50),
                                                    @ConsultationMinDate DATE, @ConsultationMaxDate DATE,
                                                    @fld_EmployeeID INT, @fld_EmployeeFirstName NVARCHAR(30),
                                                    @fld_EmployeeLastName NVARCHAR(30), @fld_CprNr NVARCHAR(10),
                                                    @fld_Email NVARCHAR(30), @fld_PhoneNr NVARCHAR(20), @fld_InterviewID INT,
                                                    @fld_InterviewName NVARCHAR(30), @AmuNr INT,
...
BEGIN
    ...
    FROM @tbl_Company
             ...
             LEFT JOIN @tbl_EducationWish ON [@tbl_Interview].fld_InterviewID = [@tbl_EducationWish].fld_InterviewID
             LEFT JOIN @tbl_FinishedEducation
    ...
    WHERE [@tbl_EducationWish].fld_InterviewID IS NOT NULL OR [@tbl_FinishedEducation].fld_InterviewID IS NOT NULL
END;